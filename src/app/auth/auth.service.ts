...
export class AuthService {
  ...
  SIGNUP_URL: string = this.API_ENDPOINT + 'signUp?key=' + environment.fireBaseAPIKEY;
  SIGIN_URL: string = this.API_ENDPOINT + 'signInWithPassword?key=' + environment.fireBaseAPIKEY;;
